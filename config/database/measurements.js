...
const getNowMeasurementsFlu = async (options) =>{
    ...
    let fields = [
        ...
        'station_prefixes.id', 'date_hour','station_prefixes.prefix','value','stations.latitude','stations.longitude','station_owners.name as station_owner', 'cities.id as city_id','cities.name as city', 'ugrhis.id as ugrhi_id', 'ugrhis.name as ugrhi', 'subugrhis.is as subugrhi_id', 'subugrhis.name as subugrhi', 'station_prefixes.measurement_gap'    
    ]
